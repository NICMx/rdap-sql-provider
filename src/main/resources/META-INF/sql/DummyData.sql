...
-- Domains
-- -----------------------------------------------------
INSERT INTO rdap.domain(dom_id,dom_handle,dom_unicode_name,dom_port43,zone_id) VALUES(1,'DOM1','whiterabbit','whois.com',1);
INSERT INTO rdap.domain VALUES(2,'DOMCOM','goldfish','whois.com',1);
INSERT INTO rdap.domain VALUES(3,'XXX2','reddog','whois.com',1);
INSERT INTO rdap.domain VALUES(4,'1234','blackcat','whois.com',1);
INSERT INTO rdap.domain VALUES(5,'ylb','yellowbird','whois.com',1);

INSERT INTO rdap.domain VALUES(6,'DOM2','conejo-blanco','whois.com.example',2);
INSERT INTO rdap.domain VALUES(7,'DOMCOMMX','pez-dorado','whois.com.example',2);
INSERT INTO rdap.domain VALUES(8,'XXX3','perro-rojo','whois.com.example',2);
INSERT INTO rdap.domain VALUES(9,'1235','gato-negro','whois.com.example',2);
INSERT INTO rdap.domain VALUES(10,'pjra','pajaro-amarillo','whois.com.example',2);

INSERT INTO rdap.domain VALUES(11,'DOM3','conejo-blanco','whois.test',3);
INSERT INTO rdap.domain VALUES(12,'DOMMX','pez-dorado','whois.test',3);
INSERT INTO rdap.domain VALUES(13,'XXX4','perro-rojo','whois.test',3);
INSERT INTO rdap.domain VALUES(14,'1236','gato-negro','whois.test',3);
INSERT INTO rdap.domain VALUES(15,'','pajaro-amarillo','whois.test',3);

INSERT INTO rdap.domain VALUES(16,'DOM4','choco','whois.net',4);
INSERT INTO rdap.domain VALUES(17,'DOMLAT','moka','whois.net',4);
INSERT INTO rdap.domain VALUES(18,'XXX6','1.0.168.192','whois.net',5);
INSERT INTO rdap.domain VALUES(19,'1238','méxico','whois.net',4); 
INSERT INTO rdap.domain VALUES(20,'xnxn','elpájaroamarillo','whois.net',4);

-- -----------------------------------------------------
-- Variant
-- -----------------------------------------------------
INSERT INTO rdap.variant VALUES (1, 'idn table', 1);
INSERT INTO rdap.variant VALUES (2, 'idn table', 2);
INSERT INTO rdap.variant VALUES (3, 'idn table', 3);
INSERT INTO rdap.variant VALUES (4, 'idn table', 4);

INSERT INTO rdap.variant VALUES (6, 'idn table', 6);
INSERT INTO rdap.variant VALUES (7, 'idn table', 7);
INSERT INTO rdap.variant VALUES (8, 'idn table', 8);

INSERT INTO rdap.variant VALUES (14, 'idn table', 14);

INSERT INTO rdap.variant VALUES (20, 'idn table', 20);

-- -----------------------------------------------------
-- Variant Name
-- -----------------------------------------------------
INSERT INTO rdap.variant_name VALUES (1, 'whitérábbít.com');
INSERT INTO rdap.variant_name VALUES (2, 'góldfísh.com');
INSERT INTO rdap.variant_name VALUES (3, 'réddóg.com');
INSERT INTO rdap.variant_name VALUES (4, 'bláckcát.com');

INSERT INTO rdap.variant_name VALUES (6, 'cónéjó-blanco.com.example');
INSERT INTO rdap.variant_name VALUES (7, 'péz-dorado.com.example');
INSERT INTO rdap.variant_name VALUES (8, 'pérro-rojo.com.example');

INSERT INTO rdap.variant_name VALUES (14, 'gátö-ñegró.example');

INSERT INTO rdap.variant_name VALUES (20, 'elpajaroamarillo.test');
...
INSERT INTO rdap.vcard_contact_uri VALUES (1, 1, 1, 'mailto:contact@example.com');
INSERT INTO rdap.vcard_contact_uri VALUES (15, 1, 1, 'https://contact.example.com');
INSERT INTO rdap.vcard_contact_uri VALUES (2, 2, 1, 'mailto:contact2@example.com');
INSERT INTO rdap.vcard_contact_uri VALUES (16, 2, 1, 'https://contact2.example.com');
INSERT INTO rdap.vcard_contact_uri VALUES (3, 3, 1, 'mailto:contact3@example.com');
INSERT INTO rdap.vcard_contact_uri VALUES (17, 3, 1, 'https://contact3.example.com');
INSERT INTO rdap.vcard_contact_uri VALUES (4, 4, 1, 'mailto:contact4@example.com');
INSERT INTO rdap.vcard_contact_uri VALUES (18, 4, 1, 'https://contact4.example.com');
INSERT INTO rdap.vcard_contact_uri VALUES (5, 5, 1, 'mailto:contact5@example.com');
INSERT INTO rdap.vcard_contact_uri VALUES (19, 5, 1, 'https://contact5.example.com');

INSERT INTO rdap.vcard_contact_uri VALUES (6, 6, 1, 'mailto:contact6@example.com');
INSERT INTO rdap.vcard_contact_uri VALUES (7, 7, 1, 'mailto:contact7@example.com');
INSERT INTO rdap.vcard_contact_uri VALUES (8, 8, 1, 'mailto:contact8@example.com');
INSERT INTO rdap.vcard_contact_uri VALUES (9, 9, 1, 'mailto:contact9@example.com');
INSERT INTO rdap.vcard_contact_uri VALUES (10, 10, 1, 'mailto:contact10@example.com');

INSERT INTO rdap.vcard_contact_uri VALUES (11, 11, 1, 'mailto:contact11@example.com');
INSERT INTO rdap.vcard_contact_uri VALUES (12, 12, 1, 'mailto:contact12@example.com');
INSERT INTO rdap.vcard_contact_uri VALUES (13, 13, 1, 'mailto:contact13@example.com');
INSERT INTO rdap.vcard_contact_uri VALUES (14, 14, 1, 'mailto:contact14@example.com');
...
-- Vcard_Postal_Info
-- -----------------------------------------------------
INSERT INTO rdap.vcard_postal_info VALUES(1, 1, 'local', 'Mexico', 'MX', 'Monterrey', 'Altavista', '100', 'Av Luis Elizondo', 'Nuevo Leon', '89420');
INSERT INTO rdap.vcard_postal_info VALUES(2, 3, 'local', 'Mexico', 'MX', 'Monterrey', 'Altavista', '100', 'Av Luis Elizondo', 'Nuevo Leon', '89421');
INSERT INTO rdap.vcard_postal_info VALUES(3, 5, 'local', 'Mexico', 'MX', 'Monterrey', 'Altavista', '100', 'Av Luis Elizondo', 'Nuevo Leon', '89422');
INSERT INTO rdap.vcard_postal_info VALUES(4, 7, 'local', 'Mexico', 'MX', 'Monterrey', 'Altavista', '100', 'Av Luis Elizondo', 'Nuevo Leon', '89423');
INSERT INTO rdap.vcard_postal_info VALUES(5, 9, 'local', 'Mexico', 'MX', 'Monterrey', 'Altavista', '100', 'Av Luis Elizondo', 'Nuevo Leon', '89424');
INSERT INTO rdap.vcard_postal_info VALUES(6, 11, 'local', 'Mexico', 'MX', 'Monterrey', 'Altavista', '100', 'Av Luis Elizondo', 'Nuevo Leon', '89425');
INSERT INTO rdap.vcard_postal_info VALUES(7, 13, 'local', 'Mexico', 'MX', 'Monterrey', 'Altavista', '100', 'Av Luis Elizondo', 'Nuevo Leon', '89426');
INSERT INTO rdap.vcard_postal_info VALUES(8, 14, 'local', 'Mexico', 'MX', 'Monterrey', 'Altavista', '100', 'Av Luis Elizondo', 'Nuevo Leon', '89427');

INSERT INTO rdap.vcard_postal_info VALUES(9, 3, 'home', 'USA', 'US', 'New York', 'Altavista', '100', 'Av Luis Elizondo', null, '89430');
INSERT INTO rdap.vcard_postal_info VALUES(10, 3, 'home', 'England', 'UK', 'London', 'Altavista', '100', 'Av Luis Elizondo', null, '89435');
INSERT INTO rdap.vcard_postal_info VALUES(11, 3, 'home', 'Rusia', 'RU','Moscow', 'Altavista', '100', 'Av Luis Elizondo', null, '89445');
INSERT INTO rdap.vcard_postal_info VALUES(12, 3, 'home', 'Ukraine', 'UA','Kiev', 'Altavista', '100', 'Av Luis Elizondo', null, '89450');
...
-- Nameservers
-- -----------------------------------------------------
INSERT INTO rdap.nameserver VALUES (1, 'NSE1', 'ns1.chopsuey.net', 'whois.net');
INSERT INTO rdap.nameserver VALUES (2, 'NSE2', 'ns2.chopsuey.net', 'whois.net');
INSERT INTO rdap.nameserver VALUES (3, 'NSE3', 'ns3.chopsuey.net', 'whois.net');
INSERT INTO rdap.nameserver VALUES (4, 'NSE4', 'ns4.chopsuey.net', 'whois.net');
INSERT INTO rdap.nameserver VALUES (5, 'NSE5', 'ns5.chopsuey.net', 'whois.net');

INSERT INTO rdap.nameserver VALUES (6, 'NSE6', 'ns1.white.example', 'whois.example');
INSERT INTO rdap.nameserver VALUES (7, 'NSE7', 'ns2.white.example', 'whois.example');
INSERT INTO rdap.nameserver VALUES (8, 'NSE8', 'ns3.white.example', 'whois.example');
INSERT INTO rdap.nameserver VALUES (9, 'NSE9', 'ns4.white.example', 'whois.example');
INSERT INTO rdap.nameserver VALUES (10,'NSE10', 'ns5.white.example', 'whois.example');

INSERT INTO rdap.nameserver VALUES (11, 'NSE11', 'ns1.bright.info', 'whois.info');
INSERT INTO rdap.nameserver VALUES (12, 'NSE12', 'ns2.bright.info', 'whois.info');
INSERT INTO rdap.nameserver VALUES (13, 'NSE13', 'ns3.bright.info', 'whois.info');
INSERT INTO rdap.nameserver VALUES (14, 'NSE14', 'ns4.bright.info', 'whois.info');
INSERT INTO rdap.nameserver VALUES (15, 'NSE15', 'ns5.bright.info', 'whois.info');

INSERT INTO rdap.nameserver VALUES (16, 'NSE16', 'ns1.camión.test', 'whois.test');
INSERT INTO rdap.nameserver VALUES (17, 'NSE17', 'ns2.camión.test', 'whois.test');
INSERT INTO rdap.nameserver VALUES (18, 'NSE18', 'ns3.camión.test', 'whois.test');
INSERT INTO rdap.nameserver VALUES (19, 'NSE19', 'ns4.camión.test', 'whois.test');
INSERT INTO rdap.nameserver VALUES (20, 'NSE20', 'ns5.camión.test', 'whois.test');
...
INSERT INTO rdap.variant_relation VALUES(5,6);
INSERT INTO rdap.variant_relation VALUES(1,7);
INSERT INTO rdap.variant_relation VALUES(2,8);

INSERT INTO rdap.variant_relation VALUES(3,14);
INSERT INTO rdap.variant_relation VALUES(4,20);
...
-- Rdap User
-- -----------------------------------------------------
INSERT INTO `rdap`.`rdap_user` (`rus_name`, `rus_pass`) VALUES ('alvin', 'alvin');
INSERT INTO `rdap`.`rdap_user` (`rus_name`, `rus_pass`) VALUES ('bob', 'bob');
INSERT INTO `rdap`.`rdap_user` (`rus_name`, `rus_pass`) VALUES ('charles', 'charles');

-- -----------------------------------------------------
-- Rdap Access Role
-- -----------------------------------------------------
INSERT INTO `rdap`.`rdap_access_role` (`rar_name`, `rar_description`) VALUES ('fbi', 'Federal Bureau of Investigation');
INSERT INTO `rdap`.`rdap_access_role` (`rar_name`, `rar_description`) VALUES ('cia', 'Central Intelligence Agency');

-- -----------------------------------------------------
-- Rdap User Role
-- -----------------------------------------------------
INSERT INTO `rdap`.`rdap_user_role` (`rus_name`, `rar_name`) VALUES ('bob', 'fbi');
INSERT INTO `rdap`.`rdap_user_role` (`rus_name`, `rar_name`) VALUES ('charles', 'cia');
INSERT INTO `rdap`.`rdap_user_role` (`rus_name`, `rar_name`) VALUES ('charles', 'fbi');
