...
CREATE TABLE IF NOT EXISTS `rdap`.`vcard_contact_uri` (
  `vcu_id` BIGINT NOT NULL AUTO_INCREMENT,
  `vca_id` BIGINT NOT NULL ,
  `vcu_order` INT UNSIGNED NOT NULL,
  `vcu_uri` VARCHAR(255) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `rdap`.`variant_name` (
  ...
  `vna_unicode_name` VARCHAR(255) NULL,
...
CREATE TABLE IF NOT EXISTS `rdap`.`vcard_postal_info` (
  ...
  `vpi_country_code` VARCHAR(2) NULL,
