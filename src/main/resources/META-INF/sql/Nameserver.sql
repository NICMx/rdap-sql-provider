...
#searchByIp4
SELECT DISTINCT(nse.nse_id), nse.nse_handle, nse.nse_port43, nse.nse_unicode_name FROM {schema}.nameserver nse join {schema}.ip_address ipa on ipa.nse_id=nse.nse_id WHERE ipa.iad_value=? ORDER BY 1 LIMIT ?;
