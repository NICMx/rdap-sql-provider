...
CREATE TABLE IF NOT EXISTS `rdap`.`ip_network` (
  ...
  `ine_start_address_down` BIGINT UNSIGNED NULL DEFAULT NULL COMMENT 'The down part of the starting IP address of the network',
  `ine_end_address_up` BIGINT UNSIGNED NULL DEFAULT NULL COMMENT 'The up part of the ending IP address of the network',
  `ine_end_address_down` BIGINT UNSIGNED NULL DEFAULT NULL COMMENT 'The down part of the ending IP address of the network',
